...
public class RegisterClient extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        TblDisplayFood.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Restaurant ID", "Food", "Price", "Category"
            }
        ));
        ...
        lbCategory3.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        lbCategory3.setText("Category :");
        ...
        cbxCategory3.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cbxCategory3ActionPerformed(evt);
            }
        });

        cbxCategory1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Main Course", "Beverage", "Dessert" }));
        cbxCategory1.addItemListener(new java.awt.event.ItemListener() {
            public void itemStateChanged(java.awt.event.ItemEvent evt) {
                cbxCategory1ItemStateChanged(evt);
            }
        });
        cbxCategory1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cbxCategory1ActionPerformed(evt);
            }
        });
                            ...
                            .addGroup(panelFoodLayout.createSequentialGroup()
                                ...
                                .addGroup(panelFoodLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                    ...
                                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, panelFoodLayout.createSequentialGroup()
                                        ...
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                        .addComponent(txtFood1, javax.swing.GroupLayout.PREFERRED_SIZE, 141, javax.swing.GroupLayout.PREFERRED_SIZE)))
                                .addGap(18, 18, 18)
                                .addGroup(panelFoodLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                    .addGroup(panelFoodLayout.createSequentialGroup()
                                        .addComponent(lblCategory2, javax.swing.GroupLayout.PREFERRED_SIZE, 94, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                        .addComponent(cbxCategory2, javax.swing.GroupLayout.PREFERRED_SIZE, 132, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    ...
                                    .addGroup(panelFoodLayout.createSequentialGroup()
                                        .addComponent(lbCategory3, javax.swing.GroupLayout.PREFERRED_SIZE, 94, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                        .addComponent(cbxCategory3, javax.swing.GroupLayout.PREFERRED_SIZE, 132, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                        .addComponent(lblPrice3, javax.swing.GroupLayout.PREFERRED_SIZE, 110, javax.swing.GroupLayout.PREFERRED_SIZE))
                                    .addGroup(panelFoodLayout.createSequentialGroup()
                                        .addComponent(lblCategory1, javax.swing.GroupLayout.PREFERRED_SIZE, 94, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                        .addComponent(cbxCategory1, javax.swing.GroupLayout.PREFERRED_SIZE, 132, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addGap(41, 41, 41)
                                ...
                                .addGroup(panelFoodLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                    .addComponent(txtPrice3, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 91, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addComponent(txtPrice2, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 91, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addComponent(txtPrice1, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 91, javax.swing.GroupLayout.PREFERRED_SIZE)))
    ...
    private void btnSubmitClientActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSubmitClientActionPerformed
        if (rdBtnCust.isSelected()) {
            ...
            String category1 = (String) cbxCategory1.getSelectedItem().toString();
            String category2 = (String) cbxCategory2.getSelectedItem().toString();
            String category3 = (String) cbxCategory3.getSelectedItem().toString();
            ...
            if (enteredId.isEmpty() || nameRest.isEmpty() || addressRest.isEmpty() || emailRest.isEmpty()
                ...
                try {
                    ...
                    // Create menu with category
                    List<Food> menu = new ArrayList<>();
                    menu.add(clientOp.createFood(food1, p1, category1));
                    menu.add(clientOp.createFood(food2, p2, category2));
                    menu.add(clientOp.createFood(food3, p3, category3));
                    ...
                    if (!clientOp.isUniqueRestId(restID)) {
                        ...
                        for (Food f : rest.getFoods()) {
                            model2.addRow(new Object[]{rest.getId(), f.getName(), f.getPrice(), f.getCategory()});
                        }
        ...
        if (rdBtnCust.isSelected()) {
            ...
            for (Restaurant r : clientOp.getRestList()) {
                ...
                for (Food f : r.getFoods()) {
                    model2.addRow(new Object[]{r.getId(), f.getName(), f.getPrice(), f.getCategory()});
                }
            }
        } else {
            JOptionPane.showMessageDialog(this, "Please Select A Client Type!", "Error", JOptionPane.ERROR_MESSAGE);
    ...
    private void cbxCategory1ItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_cbxCategory1ItemStateChanged
        // TODO add your handling code here:
    }//GEN-LAST:event_cbxCategory1ItemStateChanged

    private void cbxCategory1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cbxCategory1ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_cbxCategory1ActionPerformed

    private void cbxCategory3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cbxCategory3ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_cbxCategory3ActionPerformed
